...
<strong>Read</strong>: Users can search and filter available resources by category, availability, or owner and view detailed information including current status

<strong>Update</strong>: Resource owners can edit resource details or update availability status
...
<strong>Read</strong>: Users can view their active loans and pending requests and resource owners can see all loan requests for their resources

<strong>Update</strong>: Loan status can be updated for example approving a request, marking resources as returned or extending the borrowing period which is done by the borrower or resource owner
