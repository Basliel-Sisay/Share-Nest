...
class AppColors {
  static const Color primaryGreen = Color.fromARGB(255, 30, 132, 73);
  static const Color darkGreen = Color.fromARGB(255, 17, 92, 48);
  static const Color lightGreen = Color.fromARGB(255, 212, 238, 220);
  static const Color background = Color.fromARGB(255, 248, 250, 252);
  static const Color cardBlue = Color.fromARGB(255, 221, 232, 252);
