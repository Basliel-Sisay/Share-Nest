...
class SeedData {
  ...
  static List<ResourceItem> resources() => [
    ...
    const ResourceItem(
      ...
      rating: 4.9,
      category: 'Books',
      description: 'Comprehensive Python programming guide covering fundamentals, data structures and practical projects for beginners and intermediates',
    ...
    const ResourceItem(
      ...
      rating: 4.8,
      category: 'Tools',
      description: 'Compact Drill, built for everyday wall drilling and light home projects. Solid condition with reliable power and steady performance',
      imagePath: 'assets/images/drill.png',
      location: 'Jemo, Mekanissa',
      condition: 'Includes 2 rechargeable batteries. Charger and carrying case included',
      statusText: 'Available Today',
    ),
    const ResourceItem(
      id: 'english-textbook',
