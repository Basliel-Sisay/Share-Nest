...
function seed() {
  ...
  const resources = [
    ...
    ['book-of-daniel', 'Book of Daniel', 'user-1', 'Sarah W.', '1.5 miles', 4.9, 'Books',
      ...
      'Available Today', 1],
    ['camping-tent', 'Camping Tent', 'user-1', 'Edlawit Sewasew', '1.0km', 4.8, 'Outdoor',
      'Spacious 4-person tent for your next camping adventure.',
      'assets/images/tent.png', 'Lafto', 'Excellent condition',
      'Available Today', 1],
    ['step-ladder', 'Step Ladder', 'user-1', 'Malik Ahmed', '1.4km', 4.7, 'Tools',
    ...
    ['kitchen-set-kit', 'Kitchen Set Kit', 'user-1', 'Sarah Kinde', '1.2km', 5.0, 'Kitchen',
      ...
      'Available Today', 1],
    ['plastic-chairs', 'Plastic Chairs', 'user-1', 'Community Hub', '0.8 Km', 4.7, 'Furniture',
